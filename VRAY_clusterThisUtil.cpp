...
//   VRAY_clusterThis * me = (VRAY_clusterThis *)data;
   ...
   if(mySaveXMLFile)
      VRAY_clusterThis::exitWriteXMLFile();
...
/* ******************************************************************************
*  Function Name : exitWriteXMLFile()
*
*  Description : Write the stats, parameters, etc. to the XML file.
*
*  Input Arguments : None
*
*  Return Value :
*
* ***************************************************************************** */
void VRAY_clusterThis::exitWriteXMLFile()
{
